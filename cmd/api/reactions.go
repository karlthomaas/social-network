...
func (app *application) deletePostReactionHandler(w http.ResponseWriter, r *http.Request) {
...
func (app *application) getPostReactionHandler(w http.ResponseWriter, r *http.Request) {
...
func (app *application) addReplyReactionHandler(w http.ResponseWriter, r *http.Request) {
	...
	react, err := app.models.Reactions.Get(user.ID, replyID)
...
func (app *application) deleteReplyReactionHandler(w http.ResponseWriter, r *http.Request) {
	...
	reaction, err := app.models.Reactions.Get(userID, replyID)
	if err != nil {
		switch {
		case errors.Is(err, data.ErrRecordNotFound):
			app.notFoundResponse(w, r)
...
func (app *application) getReplyReactionHandler(w http.ResponseWriter, r *http.Request) {
	...
	parentId, err := app.readParam(r, "replyID")
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
